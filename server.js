  ...
  db.any(players)
      .then(function(rows) {
        res.render('pages/player_info',{
          ...
          rush_yds: '',
          rec_yds: '',
          image: '../resources/img/helmet.jpg'
        })
      })
      .catch(function(err) {
...
app.get('/player_info/post', function(req,res){
  var selected_player =  req.query.player_choice;
  var players = 'select id, name from football_players;';
  var player_info = "select * from football_players where id='" + selected_player + "'";
  var num_games_played = "select count(*) from football_games where players @> ARRAY[" + selected_player + "];";
  db.task('get-everything', task => {
    return task.batch([
      task.any(players),
      task.any(player_info),
      task.any(num_games_played)
      ]);
  })
  .then(info => {
    res.render('pages/player_info', {
      ...
      pass_yds: info[1][0].passing_yards,
      rush_yds: info[1][0].rushing_yards,
      rec_yds: info[1][0].receiving_yards,
